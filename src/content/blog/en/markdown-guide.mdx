...
image: '/og/markdown-guidex-en.png'
---

Markdown is a lightweight markup language that lets you create formatted documents using plain text. It's the most natural way to produce content on Astro-based sites like this one.
